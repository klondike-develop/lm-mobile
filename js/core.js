$(document).ready(function () {
	...
	//tab inner
	$(".tabs-inner").delegate("li:not(.active)", "click", function () {
		$(this).addClass("active").siblings().removeClass("active").parents(".tab-inner").find(".box-inner").hide().eq($(this).index()).fadeIn(250);
	});
